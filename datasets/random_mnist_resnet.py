...
class RandomMNISTResNet(ContinualDataset):

    NAME = 'random-mnist-resnet'
    ...
    def get_backbone(self):
        ...
        if self.SETTING == 'class-il':
            return mnist_resnet18(nclasses = len(datasets.random_setting.unique_label_list), grayscale = True)
        return mnist_resnet18(nclasses = self.N_TASKS * self.N_CLASSES_PER_TASK, grayscale = True)
