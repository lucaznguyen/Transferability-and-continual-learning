...
class RandomCIFAR100(ContinualDataset):

    NAME = 'random-cifar100'
    ...
    def get_backbone(self):
        if RandomCIFAR100.SETTING == 'class-il':
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), RandomCIFAR100.TRANSFORM])
        return transform
    ...
    def get_minibatch_size():
        return RandomCIFAR100.get_batch_size()
