...
class MyTissueMNIST(TissueMNIST):
    """
    ...
    def __init__(self, root, split="train", transform=None,
        ...
        super(TissueMNIST, self).__init__(root=root, split=split,
...
class RandomTissueMNIST(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        os.makedirs(base_path() + 'TissueMNIST', exist_ok=True)
        ...
        train_dataset = MyTissueMNIST(root = base_path() + 'TissueMNIST',
                                split="train", download=True, transform=transform)
        ...
        if self.args.validation:
            ...
            test_dataset = MyTissueMNIST(root = base_path() + 'TissueMNIST',
