...
def main(args=None):
    ...
    # if not os.path.exists("visualize/"+args.model):
    #     os.mkdir("visualize/"+args.model)
    #     os.mkdir(save_dir)
    # else:
    #     if not os.path.exists("visualize/"+args.model+"/"+scenario):
    #         os.mkdir("visualize/"+args.model+"/"+scenario)
    #         os.mkdir(save_dir)
    #     else:
    #         if not os.path.exists("visualize/"+args.model+"/"+scenario+"/"+str(args.n_task_per_seq)+" task/"):
    #             os.mkdir("visualize/"+args.model+"/"+scenario+"/"+str(args.n_task_per_seq)+" task/")
    #             os.mkdir(save_dir)
    #         else:
    #             if not os.path.exists("visualize/"+args.model+"/"+scenario+"/"+args.n_task_per_seq+" task/"+"1200 sample/"):
    #                 os.mkdir("visualize/"+args.model+"/"+scenario+"/"+args.n_task_per_seq+" task/"+"1200 sample/")
    #                 os.mkdir(save_dir)
    #             else:
    ...
    for s in range(args.num_seq):
        ...
        if isinstance(dataset, ContinualDataset):
            ...
            leep_1stacc, bwt_leep = train_random(model, dataset, args)
